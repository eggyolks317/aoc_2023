...
public class day1_p1 {
    public static void main(String[] args) {
        String[] array = makeArray("gsjgklneight6zqfz\n" +
        ...
        for (String string : array) {
            sum += findDigit(string);
            System.out.println("input: " + string);
            System.out.println("num: " + findDigit(string));
    ...
    public static int findDigit (String string) {
        int [] array  = new int [string.length()+1];
        int z = 0;
        int a = 0;
        for (int x = 0; x <string.length() ; x++) {
            if (isNumber (string.charAt(x))) {
                array[z] = string.charAt(x)-48;
                z++;
            }
        }
        while (array[a] != 0){
